function Peppermint(a, b) {
  ...
  function g(a, b) {
    ...
    return (
      e(C.dots[a], G.activeDot),
      (E = a),
      h(-a * C.width, void 0 === b ? F.speed : b),
      o(),
      F.onSlideChange && F.onSlideChange(a),
      a
    );
  }
  function h(a, b) {
    var c = b ? b + "ms" : "";
    (y.style.webkitTransitionDuration =
      y.style.MozTransitionDuration =
      y.style.msTransitionDuration =
      y.style.OTransitionDuration =
  ...
  function i(a, b) {
    ...
    B = setInterval(function () {
      ...
      var f,
        ...
        k = [0, 0.7, 1, 1];
      return i >= 1
        ? (j(a), void clearInterval(B))
        : ((f = a - d),
          (g = e(
            e(e(k[0], k[1]), e(k[1], k[2])),
            e(e(k[1], k[2]), e(k[2], k[3]))
          )),
          void j(Math.floor(g * f + d)));
    }, 15);
  }
  function j(a) {
    (y.style.webkitTransform = "translate(" + a + "px,0) translateZ(0)"),
      (y.style.msTransform =
      ...
      move: function (a, b, c) {
        ...
        if (d.x) {
          var e = Math.abs(d.x) / C.width,
            h = Math.floor(e) + (e - Math.floor(e) > 0.25 ? 1 : 0),
            i =
              d.time < D + (D * h) / 1.8 &&
              Math.abs(d.x) - h * C.width > (h ? -C.width / 9 : 20);
          (h += i ? 1 : 0),
            d.x < 0 ? g(E + h, F.touchSpeed) : g(E - h, F.touchSpeed),
            F.stopSlideshowAfterInteraction && q();
        }
        f(a, G.drag);
      },
    });
  ...
  function u() {
    ...
    if (!(F.disableIfOneSlide && b.children.length <= 1)) {
      (!H.transforms || window.opera) && (j = k),
        (!H.transitions || window.opera) && (h = i),
        (y = F.slidesContainer || document.createElement("div")),
        e(y, G.slides);
      ...
      (v = C.slides.length),
        ...
        e(a, G.active),
        f(a, G.inactive),
        F.mouseDrag && e(a, G.mouse),
        (C.width = a.offsetWidth),
        (y.style.width = C.width * v + "px");
      for (var d = 0; v > d; d++)
...
function EventBurrito(a, b) {
  ...
  function g(a) {
    if (
      ...
      (s = {
        ...
        t.length >= 5 && t.shift(),
        t.push({ x: r.x, y: r.y, time: r.time });
    }
  }
  function h(a, b) {
    (v = !0),
  ...
  function i(a) {
    (!m.preventScroll && n) ||
      y[o](a) ||
      (g(a),
      (Math.abs(r.x) > m.clickTolerance || Math.abs(r.y) > m.clickTolerance) &&
        (v = !1),
      (void 0 === n &&
        3 !== o &&
        (n = Math.abs(r.x) < Math.abs(r.y) && !m.preventScroll)) ||
        (m.preventDefault && f(a), m.move(a, q, r, s)));
  }
  function j(a) {
    o && g(a),
      !v && a.target && a.target.blur && a.target.blur(),
      e(document, x[o][1], i),
      e(document, x[o][2], j),
      e(document, x[o][3], j),
      m.end(a, q, r, s);
  ...
  function k() {
    u.push(
      d(a, x[w][0], function (a) {
        h(a, w);
      })
    ),
      u.push(d(a, "dragstart", f)),
      m.mouse &&
        !w &&
        u.push(
          d(a, x[3][0], function (a) {
            h(a, 3);
          })
        ),
      u.push(
  ...
  var n,
    ...
    y = [
      function (a) {
        return (
          (a.touches && a.touches.length > 1) || (a.scale && 1 !== a.scale)
        );
      },
      function (a) {
        return (
          !a.isPrimary ||
          (a.buttons && 1 !== a.buttons) ||
          (!m.mouse && "touch" !== a.pointerType && "pen" !== a.pointerType)
        );
      },
      function (a) {
        return (
          ...
          (!m.mouse &&
            ...
            a.pointerType !== a.MSPOINTER_TYPE_PEN)
        );
      },
      function (a) {
